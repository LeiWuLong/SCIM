...
namespace SCIM
{
    public partial class SCIM_Dashboard : Form
    {
        private int childFormNumber = 0;

        public SCIM_Dashboard()
        {
            InitializeComponent();
        }
        ...
        private void SCIM_Dashboard_Load(object sender, EventArgs e)
        {
        ...
        private void addProdMnuItm_Click(object sender, EventArgs e)
        {
            IProductService productService = new ProductService();
            FrmProduct childForm = new FrmProduct(productService);
            childForm.MdiParent = this;
            // childForm.Text = "FrmUser " + childFormNumber++;
            childForm.Dock = DockStyle.Fill;
